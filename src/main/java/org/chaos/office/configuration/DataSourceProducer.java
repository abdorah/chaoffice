...
public class DataSourceProducer {
    ...
    public void addDataSource(String name, String jdbcUrl, String username, String password) throws SQLException {
    ...
    private AgroalDataSource createDataSource(String database, String username, String password) throws SQLException {
        AgroalDataSourceConfigurationSupplier configurationSupplier = new AgroalDataSourceConfigurationSupplier();

        AgroalDataSourceConfiguration configuration = configurationSupplier
                .connectionPoolConfiguration(cp -> cp
                        .initialSize(5)
                        .minSize(5)
                        .maxSize(10)
                        .connectionFactoryConfiguration(cf -> cf
                                .jdbcUrl(String.format("jdbc:sqlite:data/%s.db", database))
