...
public class DatabaseService {
    ...
    public void initDataSource(String name, String path, String user, String password) throws SQLException {
    ...
    public void saveCheckPoint(String dataSourceName, String backUpName, String user, String password) throws SQLException, IOException {
        // Get the path of database file
        File database = new File(dataSourceProducer.getDataSource(dataSourceName).getConnection().getMetaData().getURL());
