...
public class DataService {
    ...
    private static final MessageFormat LOAD_DATA_STATEMENT =
            new MessageFormat("LOAD DATA INFILE ''{0}'' INTO TABLE {1} FIELDS TERMINATED BY '','' ENCLOSED BY ''\"\'' LINES TERMINATED BY ''\n'' IGNORE 1 ROWS;");
    ...
    public void deleteColumn(String dataSourceName, String tableName, String columnName) {
        Jdbi jdbi = databaseService.useDataSource(dataSourceName);
        String deleteColumnStatement = DELETE_COLUMN_STATEMENT.format(new Object[]{tableName, columnName});
