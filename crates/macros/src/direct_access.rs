// Generated by Qleany v1.5.5 from macros_direct_access.tera
...
pub fn uow_action_impl(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let function_name = match action.as_str() {
        ...
        "UpdateWithRelationships" => {
            format!("update_with_relationships_{}", entity_name_snake_case)
        }
        "UpdateWithRelationshipsMulti" => {
            format!("update_with_relationships_{}_multi", entity_name_snake_case)
        }
