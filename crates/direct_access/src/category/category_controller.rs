...
use super::{
    ...
    units_of_work::{CategoryReadUoWFactory, CategoryWriteUoWFactory},
};
use crate::CategoryRelationshipDto;
...
pub fn create_orphan(
    ...
    let uow_factory = CategoryWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::Category = entity.into();
...
pub fn create_orphan_multi(
    ...
    undo_redo_manager: &mut UndoRedoManager,
    stack_id: Option<u64>,
    entities: &[CreateCategoryDto],
) -> Result<Vec<CategoryDto>> {
    let uow_factory = CategoryWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Category> =
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<CategoryDto>> {
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute(id)?.map(|e| e.into()))
}

pub fn get_all(db_context: &DbContext) -> Result<Vec<CategoryDto>> {
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute_all()?.into_iter().map(|e| e.into()).collect())
}

pub fn get_multi(db_context: &DbContext, ids: &[EntityId]) -> Result<Vec<Option<CategoryDto>>> {
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc
        .execute_multi(ids)?
...
pub fn get_relationship(
    ...
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipUseCase::<CategoryRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipManyUseCase::<CategoryRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipCountUseCase::<CategoryRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = CategoryReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipInRangeUseCase::<CategoryRelationshipField, _>::new(uow_factory);
...
pub fn set_relationship(
    ...
    let uow_factory = CategoryWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableSetRelationshipUseCase::<CategoryRelationshipField, _>::new(uow_factory);
...
pub fn move_relationship(
    ...
    let uow_factory = CategoryWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableMoveRelationshipUseCase::<CategoryRelationshipField, _>::new(
        uow_factory,
    );
