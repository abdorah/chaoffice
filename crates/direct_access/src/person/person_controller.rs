...
use super::{
    dtos::{CreatePersonDto, PersonDto, UpdatePersonDto},
    units_of_work::{PersonReadUoWFactory, PersonWriteUoWFactory},
};
use crate::PersonRelationshipDto;
...
pub fn create_orphan(
    ...
    stack_id: Option<u64>,
    entity: &CreatePersonDto,
) -> Result<PersonDto> {
    let uow_factory = PersonWriteUoWFactory::new(db_context, event_hub);
    let mut uc = use_cases::UndoableCreateOrphanUseCase::new(uow_factory);
    let entity_in: common::entities::Person = entity.into();
...
pub fn create_orphan_multi(
    ...
    let uow_factory = PersonWriteUoWFactory::new(db_context, event_hub);
    let entities_in: Vec<common::entities::Person> =
...
pub fn get(db_context: &DbContext, id: &EntityId) -> Result<Option<PersonDto>> {
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute(id)?.map(|e| e.into()))
}

pub fn get_all(db_context: &DbContext) -> Result<Vec<PersonDto>> {
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc.execute_all()?.into_iter().map(|e| e.into()).collect())
}

pub fn get_multi(db_context: &DbContext, ids: &[EntityId]) -> Result<Vec<Option<PersonDto>>> {
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc = use_cases::GetUseCase::new(uow_factory);
    Ok(uc
        .execute_multi(ids)?
...
pub fn get_relationship(
    ...
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipUseCase::<PersonRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_many(
    ...
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipManyUseCase::<PersonRelationshipField, _>::new(uow_factory);
...
pub fn get_relationship_count(
    ...
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc = use_cases::GetRelationshipCountUseCase::<PersonRelationshipField, _>::new(uow_factory);
    uc.execute(id, field)
}
...
pub fn get_relationship_in_range(
    ...
    let uow_factory = PersonReadUoWFactory::new(db_context);
    let uc =
        use_cases::GetRelationshipInRangeUseCase::<PersonRelationshipField, _>::new(uow_factory);
...
pub fn set_relationship(
    ...
    let uow_factory = PersonWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableSetRelationshipUseCase::<PersonRelationshipField, _>::new(uow_factory);
...
pub fn move_relationship(
    ...
    let uow_factory = PersonWriteUoWFactory::new(db_context, event_hub);
    let mut uc =
        use_cases::UndoableMoveRelationshipUseCase::<PersonRelationshipField, _>::new(uow_factory);
