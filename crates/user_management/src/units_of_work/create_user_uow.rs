...
use crate::use_cases::create_user_uc::{
    CreateUserUnitOfWorkFactoryTrait, CreateUserUnitOfWorkTrait,
};
...
// Unit of work for CreateUser

pub struct CreateUserUnitOfWork {
    context: DbContext,
...
impl CreateUserUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        CreateUserUnitOfWork {
...
impl CommandUnitOfWork for CreateUserUnitOfWork {
...
pub struct CreateUserUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl CreateUserUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        CreateUserUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl CreateUserUnitOfWorkFactoryTrait for CreateUserUnitOfWorkFactory {
    fn create(&self) -> Box<dyn CreateUserUnitOfWorkTrait> {
        Box::new(CreateUserUnitOfWork::new(&self.context, &self.event_hub))
    }
}
