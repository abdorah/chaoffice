...
use crate::use_cases::change_password_uc::{
    ChangePasswordUnitOfWorkFactoryTrait, ChangePasswordUnitOfWorkTrait,
};
...
// Unit of work for ChangePassword

pub struct ChangePasswordUnitOfWork {
    context: DbContext,
...
impl ChangePasswordUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        ChangePasswordUnitOfWork {
...
impl CommandUnitOfWork for ChangePasswordUnitOfWork {
...
pub struct ChangePasswordUnitOfWorkFactory {
    context: DbContext,
    event_hub: Arc<EventHub>,
}

impl ChangePasswordUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        ChangePasswordUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl ChangePasswordUnitOfWorkFactoryTrait for ChangePasswordUnitOfWorkFactory {
    fn create(&self) -> Box<dyn ChangePasswordUnitOfWorkTrait> {
        Box::new(ChangePasswordUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
