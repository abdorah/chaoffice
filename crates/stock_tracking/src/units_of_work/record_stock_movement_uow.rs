...
use crate::use_cases::record_stock_movement_uc::{
    RecordStockMovementUnitOfWorkFactoryTrait, RecordStockMovementUnitOfWorkTrait,
};
...
// Unit of work for RecordStockMovement

pub struct RecordStockMovementUnitOfWork {
    context: DbContext,
...
impl RecordStockMovementUnitOfWork {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RecordStockMovementUnitOfWork {
...
impl CommandUnitOfWork for RecordStockMovementUnitOfWork {
...
impl RecordStockMovementUnitOfWorkFactory {
    pub fn new(db_context: &DbContext, event_hub: &Arc<EventHub>) -> Self {
        RecordStockMovementUnitOfWorkFactory {
            context: db_context.clone(),
            event_hub: event_hub.clone(),
        }
    }
...
impl RecordStockMovementUnitOfWorkFactoryTrait for RecordStockMovementUnitOfWorkFactory {
    fn create(&self) -> Box<dyn RecordStockMovementUnitOfWorkTrait> {
        Box::new(RecordStockMovementUnitOfWork::new(
            &self.context,
            &self.event_hub,
        ))
    }
